...
class BlockedStudentScreen extends ConsumerWidget {
  const BlockedStudentScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Your student account has been temporarily blocked by the administration.\n\nPlease contact the Support Admin or University transport department for further details.",
                textAlign: TextAlign.center,
                style: GoogleFonts.poppins(
                  fontSize: 16,
